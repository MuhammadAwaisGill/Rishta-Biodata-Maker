      ...
      child: Column(
        children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          if (biodata.name.isNotEmpty)
                            Text(biodata.name, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: _pink)),
          ...
          Container(
            ...
            child: const Center(
              child: Text('❀ Made with Rishta Biodata Maker ❀', style: TextStyle(fontSize: 11, color: Colors.white)),
            ),
          ),
        ],
      ),
