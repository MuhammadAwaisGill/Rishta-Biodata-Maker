          ...
          child: Column(
            children: [
                ...
                child: Column(
                  children: [
                    const Text('RISHTA BIODATA',
                        style: TextStyle(fontSize: 8, color: _sky, letterSpacing: 3)),
                ...
                child: Column(
                  children: [
                    if (biodata.whatsappNumber.isNotEmpty) ...[
                      buildQrCode(foregroundColor: _indigo, backgroundColor: _bg, size: 70),
                    ...
                    buildInfoRow(label: 'Marital Status', value: biodata.maritalStatus, labelColor: _lightIndigo, valueColor: Colors.black87),
                    buildNotesRow(value: biodata.personalNotes, labelColor: _lightIndigo, valueColor: Colors.black87),
                    ...
                    buildNotesRow(value: biodata.educationNotes, labelColor: _lightIndigo, valueColor: Colors.black87),
                    ...
                    buildSiblingsRow(label: 'Brothers', count: biodata.brothers, married: biodata.brothersMarried, labelColor: _lightIndigo, valueColor: Colors.black87),
                    buildSiblingsRow(label: 'Sisters',  count: biodata.sisters,  married: biodata.sistersMarried,  labelColor: _lightIndigo, valueColor: Colors.black87),
                    ...
                    buildNotesRow(value: biodata.familyNotes, labelColor: _lightIndigo, valueColor: Colors.black87),

                    buildSectionTitle(title: 'Religious', color: _indigo),
                    buildInfoRow(label: 'Religion',      value: biodata.religion,      labelColor: _lightIndigo, valueColor: Colors.black87),
                    ...
                    buildNotesRow(value: biodata.religiousNotes, labelColor: _lightIndigo, valueColor: Colors.black87),
              ...
              Container(
                ...
                child: const Center(
                  child: Text('Made with Rishta Biodata Maker', style: TextStyle(fontSize: 9, color: _sky)),
                ),
              ),
            ],
          ),
  ...
  Widget _buildHeroPhoto() {
    if (biodata.photoPath.isNotEmpty) {
      return SizedBox(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            Image.file(File(biodata.photoPath), fit: BoxFit.cover),
            DecoratedBox(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.transparent, _indigo.withOpacity(0.5)],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.person_rounded, size: 60, color: _indigo.withOpacity(0.3)),
          const SizedBox(height: 4),
          Text('Add a photo in the form', style: TextStyle(fontSize: 11, color: _indigo.withOpacity(0.5))),
        ],
      ),
    );
  }
