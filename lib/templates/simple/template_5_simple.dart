          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    buildPhoto(photoPath: biodata.photoPath, borderColor: _dark, size: 68),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('BIODATA', style: TextStyle(fontSize: 8, color: _grey, letterSpacing: 3, fontWeight: FontWeight.w600)),
                          ...
                          if (biodata.profession.isNotEmpty)
                            Text(biodata.profession, style: const TextStyle(fontSize: 10, color: _grey), maxLines: 1, overflow: TextOverflow.ellipsis),
                    ...
                    buildQrCode(foregroundColor: _dark, backgroundColor: Colors.white),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    buildNotesRow(value: biodata.personalNotes, labelColor: _grey, valueColor: _dark),
                    ...
                    buildNotesRow(value: biodata.educationNotes, labelColor: _grey, valueColor: _dark),
                    ...
                    buildSiblingsRow(label: 'Brothers', count: biodata.brothers, married: biodata.brothersMarried, labelColor: _grey, valueColor: _dark),
                    buildSiblingsRow(label: 'Sisters',  count: biodata.sisters,  married: biodata.sistersMarried,  labelColor: _grey, valueColor: _dark),
                    ...
                    buildNotesRow(value: biodata.familyNotes, labelColor: _grey, valueColor: _dark),

                    buildSectionTitle(title: 'Religious', color: _dark),
                    buildInfoRow(label: 'Religion',      value: biodata.religion,      labelColor: _grey, valueColor: _dark),
                    ...
                    buildNotesRow(value: biodata.religiousNotes, labelColor: _grey, valueColor: _dark),

                    if (biodata.notes.isNotEmpty) ...[
                      buildSectionTitle(title: 'Notes', color: _dark),
                      Text(biodata.notes,
                          style: const TextStyle(fontSize: 10, color: _dark, height: 1.3),
              ...
              Container(
                ...
                child: const Center(
                  child: Text('Made with Rishta Biodata Maker', style: TextStyle(fontSize: 9, color: _grey)),
                ),
              ),
            ],
          ),
